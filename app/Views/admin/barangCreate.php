                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse bg-light rounded-3" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="Harga1" name="harga1" value="<?= old('harga1'); ?>">
                                </div>
                                <div class="col-md-4">
                                    <label for="Harga2" class="form-label">Harga2 (5KG)</label>
                                    <input type="number" class="form-control" id="Harga2" name="harga2" value="<?= old('harga2'); ?>">
                                </div>
                                <div class="col-md-4">
                                    <label for="Harga3" class="form-label">Harga3 (10KG)</label>
                                    <input type="number" class="form-control" id="Harga3" name="harga3" value="<?= old('harga3'); ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="Harga4" class="form-label">Harga4 (1/2 Pickup)</label>
                                    <input type="number" class="form-control" id="Harga4" name="harga4" value="<?= old('harga4'); ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="Harga5" class="form-label">Harga5 (1 Pickup)</label>
                                    <input type="number" class="form-control" id="Harga5" name="harga5" value="<?= old('harga5'); ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="Harga6" class="form-label">Harga6 (1/2 Truck)</label>
                                    <input type="number" class="form-control" id="Harga6" name="harga6" value="<?= old('harga6'); ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="Harga7" class="form-label">Harga7 (1 Truck)</label>
                                    <input type="number" class="form-control" id="Harga7" name="harga7" value="<?= old('harga7'); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <label for="gambarCreate" class="d-flex form-label">Sampul</label>
                        <img src="/img/barang/default.jpg" class="gambarCreate img-fluid img-thumbnail img-preview">
                    </div>
                    <div class="col-md-8">
